              ...
              <CardFooter className="gap-4">
                ...
                <div className="flex gap-2 w-full">
                  ...
                  {hasPermissionClient(user?.permissions, "package_delete") && (
                    ...
                    </Button> //Added by Faysal only delete button (25/9/2025)
                  )}
                </div>
              </CardFooter>
            </Card>
...
//   // ⛔ DELETE: cascades as per server-side script
//   const deletePackage = async (id: string) => {
//     const confirmed = confirm(
//       "Are you sure you want to delete this package? This will permanently remove all related templates, assignments, tasks, comments, reports, notifications, and settings."
//     );
//     if (!confirmed) return;

//     setDeletingId(id);
//     try {
//       const res = await fetch(`/api/zisanpackages/${id}`, {
//         method: "DELETE",
//         headers: {
//           "x-actor-id": user?.id || "",
//         },

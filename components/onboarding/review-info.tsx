...
export function ReviewInfo({ formData, onPrevious }: ReviewInfoProps) {
    ...
    return (
        <div className="space-y-8 p-4">
            ...
            {(formData.status || formData.progress !== undefined) && (
                <Card className="border-0 bg-gradient-to-r from-slate-50 to-slate-100/50 shadow-lg rounded-2xl">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-sm">Current setup and progress</p>
                                </div>
                            </div>
                            <StatusBadge status={formData.status} progress={formData.progress} />
                        </div>
                    </CardContent>
                </Card>
            )}
